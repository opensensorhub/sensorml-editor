...
/**
 * The Class GenericMap is responsible of creating a map displaying a single point.
 */
public class GenericPointMap {
	 ...
	 * @param drag the drag
	 */
	public GenericPointMap(double lat,double lon,String epsgCode, boolean drag) {
		this.lat = lat;
		this.lon = lon;
	 ...
	 * @param drag the drag
	 */
	public GenericPointMap(double lat,double lon,double trueHeading,String epsgCode, boolean drag) {
		this.lat = lat;
		this.lon = lon;
		this.epsgCode = epsgCode;
		this.drag = drag;

 ...
 *
 */
public class DynamicDisclosureElementPanel extends AbstractPanel<RNGElement>{
	...
	public DynamicDisclosureElementPanel(RNGElement element) {
		super(element);
